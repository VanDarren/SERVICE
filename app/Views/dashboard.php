...
<tbody>
    ...
    <?= !empty($key['estimasi_waktu']) ? htmlspecialchars($key['estimasi_waktu']) : 'None' ?>
            ...
            <td><?= !empty($key['tanggal_permintaan']) ? htmlspecialchars($key['tanggal_permintaan']) : 'N/A' ?></td>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="detailsForm" action="<?= base_url('home/editdetail/'.$key->id_pesanan) ?>" method="POST">
